...
public class StudentRegisterController {
    ...
    void register() {
        try {
            ...
            Student s1 = new Student(id, name, email, password);
            LearningSystem.students.add(s1);

            // Writing to File
            String arg = String.format("%s,%s,%s,%s,0,0", id, name, email, password);
            try (FileWriter fw = new FileWriter("static/Students.csv", true);
